...
sed -i 's/Tango/elementary-xfce/g' /etc/xdg/xfce4/xfconf/xfce-perchannel-xml/xsettings.xml
sed -i 's/menu:/:/g' /etc/xdg/xfce4/xfconf/xfce-perchannel-xml/xsettings.xml
cp -f default/xfce4/xfconf/* /etc/xdg/xfce4/xfconf/xfce-perchannel-xml/
