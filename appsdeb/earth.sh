...
echo "deb [signed-by=/etc/apt/keyrings/packages.google.gpg] http://dl.google.com/linux/earth/deb/ stable main" | tee /etc/apt/sources.list.d/google-earth-pro.list > /dev/null
