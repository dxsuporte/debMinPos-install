...
if [ -e ./xampp-linux*.run ]; then
    ...
    curl -fSL https://sinalbr.dl.sourceforge.net/project/xampp/XAMPP%20Linux/"$RELEASE"/xampp-linux-x64-"$RELEASE"-0-installer.run -o /tmp/xampp-linux-x64-installer.run
